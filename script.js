const options = {
	method: 'GET',
	headers: {
		'X-RapidAPI-Key': '4d30d75a67mshd28397eff4905c1p1d366fjsn3b87dc05ed4a',
...
fetch('https://weather-by-api-ninjas.p.rapidapi.com/v1/weather?city=Meerut', options)
	.then(response => response.json()) 
	.then((response) => {
...
fetch('https://weather-by-api-ninjas.p.rapidapi.com/v1/weather?city=Chhapra', options)
	.then(response => response.json()) 
	.then((response) => {
